        ...
        <section className='mt-[100px] flex flex-col items-center'>
            <div className='flex flex-col'>
                <div className='relative border-[2px] max-sm:border-[1px] border-[#ABB2BF] rounded-[6px] p-[25px] max-lg:p-[15px]'>
                    ...
                    <Image src={iconQuotationMarks} alt='aspas' className='absolute bottom-[-10px] max-lg:bottom-[-9px] max-md:bottom-[-8px] max-lsm:bottom-[-7px] right-[15px] bg-background px-[10px] w-fit max-lg:w-[45px] max-md:w-[40px] max-lsm:w-[35px] z-10 transform scale-x-[-1]' />
