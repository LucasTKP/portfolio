...
function SocialMedia() {
  return (  
      <section className='absolute right-[2%] max-lg:right-[3px] top-0 h-[300px] max-lg:h-[200px] max-sm:h-[120px] flex flex-col items-center'>
        ...
        <a href='https://www.linkedin.com/in/lucas-gean-dos-santos/' target='__blank'><Image src={linkedin} alt='linkedin' className='w-[30px] max-lg:w-[26px] hover:brightness-75 cursor-pointer duration-200' /></a>
      </section>
  )
}
